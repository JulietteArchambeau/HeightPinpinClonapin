...
# Careful! In the test dataset, you need to normalize with the mean and variance of the train dataset
...
test <- readRDS(file="data/TestP1.RDS")
...
test$ppet_max_1y_site.sc <- (test$ppet_max_1y_site - mean(train$ppet_max_1y_site)) / sd(train$ppet_max_1y_site)
...
test <- readRDS(file="data/TestP2.RDS")
...
# saveRDS(test, file="data/TestP2prepared.RDS")
...
test <- readRDS(file="data/TestP3.RDS")
