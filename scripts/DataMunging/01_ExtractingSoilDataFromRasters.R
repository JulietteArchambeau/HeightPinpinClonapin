...
water_top <- raster("../data/raw-data/soil/DERIVED_LAYERS/STU_EU_T_TAWC_WGS84.tif")
...
water_sub <- raster("../data/raw-data/soil/DERIVED_LAYERS/STU_EU_S_TAWC_WGS84.tif")
