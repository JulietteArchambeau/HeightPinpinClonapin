...
#  Panel A: Variance partitioning (Model M1)  #####
#  =========================================  "
...
#  Panel B: Platic (environment) component (model M3)   ####
#  ==================================================   "
...
source("scripts/Functions/vir_lite.R") # script available here: https://github.com/JulietteArchambeau/HeightPinpinClonapin/blob/master/scripts/Functions/vir_lite.R
ds=0.7
...
#  Panel C: Genetic component (model M6)   ####
#  =====================================   "
...
# We save the figure as a pdf for later adjustments with the Inkscape software:
