...
**From the dataset `HeightClimateSoilData_33121obs_25variables.csv`.**
...
Meaning of the columns:
  ...
  - `bio1_prov` (*mean.temp* in the manuscript): average of the annual daily mean temperature in the provenances (°C).
  - `bio5_prov` (*max.temp* in the manuscript): average of the maximum temperature of the warmest month in the provenances (°C).
  - `bio12_prov` (*min.pre* in the manuscript): average of the precipitation of the driest month in the provenances (mm).
  - `bio14_prov` (*mean.pre* in the manuscript): average of the annual precipitation in the provenances (mm).
