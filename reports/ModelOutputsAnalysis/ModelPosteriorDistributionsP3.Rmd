---
title: "Model posterior distributions - P3 partition"
...
```{r loadM0}
mod <- readRDS(file="../../outputs/models/P3/MOD0.rds")
```
...
# print(xtable(tab, type = "latex",digits=3), file = paste0("../../tables/Posteriors/M0_MainVarPost_P3.tex"), include.rownames=FALSE,sanitize.text.function = function(x) {x})
```
...
#ggsave(p,file="../../figs/SuppInfo/M0_PostMainVar_P3.png",height=8) 
p
```
...
# print(xtable(df, type = "latex",digits=3), file = paste0("../../tables/Posteriors/M0_SiteInterceptsPost_P3.tex"), include.rownames=FALSE,sanitize.text.function = function(x) {x})
```
...
p
# ggsave(p,file="../../figs/SuppInfo/M0_SiteInterceptsPost_P3.png",height=7,width=12)
```
...
```{r loadM1}
mod <- readRDS(file="../../outputs/models/P3/MOD1.rds")
```
...
# tab <- bind_rows(df,df2)
# print(xtable(tab, type = "latex",digits=3), file = paste0("../../tables/Posteriors/M1_MainVarPost_P3.tex"), include.rownames=FALSE,sanitize.text.function = function(x) {x})
```
...
p <- ggarrange(p1,p2,p3,labels=c("A","B","C"),font.label = list(size=20),heights = c(1,0.3,0.7),nrow=3,vjust=c(1.3,0.8,1))
#ggsave(p,file="../../figs/SuppInfo/M1_PostMainVar_P3.png",height=8) 
p
```
...
# print(xtable(df, type = "latex",digits=3), file = paste0("../../tables/Posteriors/M1_SiteInterceptsPost_P3.tex"), include.rownames=FALSE,sanitize.text.function = function(x) {x})
```
...
p
# ggsave(p,file="../../figs/SuppInfo/M1_SiteInterceptsPost_P3.png",height=7,width=12)
```
...
p <- plot(conditional_effects(mod,"age.sc"),plot=FALSE)[[1]] + 
  ...
  theme_bw()
p
#ggsave(p,file="../../figs/SuppInfo/M1_CondEffectAge_P3.png",height=6,width=6)
```
...
# print(xtable(df, type = "latex",digits=3), file = paste0("../../tables/Posteriors/M1_ProvInterceptsPost_P3.tex"), include.rownames=FALSE,sanitize.text.function = function(x) {x})
```
...
p
#ggsave(p,file="../../figs/SuppInfo/M1_ProvInterceptsPost_P3.png",height=10,width=10)
```
...
```{r loadM2}
mod <- readRDS(file="../../outputs/models/P3/MOD2.rds")
```
...
# tab <- bind_rows(df,df2)
# print(xtable(tab, type = "latex",digits=3), file = paste0("../../tables/Posteriors/M2_MainVarPost_P3.tex"), include.rownames=FALSE,sanitize.text.function = function(x) {x})
```
...
p <- ggarrange(p1,p2,p3,labels=c("A","B","C"),font.label = list(size=20),heights = c(1,0.3,0.7),nrow=3,vjust=c(1.3,0.8,1))
#ggsave(p,file="../../figs/SuppInfo/M2_PostMainVar_P3.png",height=8) 
p
```
...
g <-  ggarrange(pp2_all,pp2_asturias,pp2_bordeaux,pp2_caceres,pp2_portugal,pp2_madrid ,
                nrow=1)
g
#ggsave(g,file="../../figs/SuppInfo/M2_SiteProvIntercepts_P3.png",width=20,height=12) 
```
...
```{r loadM7}
mod <- readRDS(file="../../outputs/models/P3/MOD7.rds") 
```
...
# tab <- bind_rows(df,df2)
# print(xtable(tab, type = "latex",digits=3), file = paste0("../../tables/Posteriors/M7_MainVarPost_P3.tex"), include.rownames=FALSE,sanitize.text.function = function(x) {x})
```
...
#ggsave(p,file="../../figs/SuppInfo/M7_PostMainVar_P3.png",height=8) 
p
```
...
```{r loadM8}
mod <- readRDS(file="../../outputs/models/P3/MOD8.rds")
```
...
# tab <- bind_rows(df,df2)
# print(xtable(tab, type = "latex",digits=3), file = paste0("../../tables/Posteriors/M8_MainVarPost_P3.tex"), include.rownames=FALSE,sanitize.text.function = function(x) {x})
```
...
p <- ggarrange(p1,p2,p3,labels=c("A","B","C"),font.label = list(size=20),heights = c(0.9,0.35,0.55),nrow=3,vjust=c(1.2,1,1))
#ggsave(p,file="../../figs/SuppInfo/M8_PostMainVar_P3.png",height=8)  
p
```
...
```{r loadM9}
mod <- readRDS(file="../../outputs/models/P3/MOD9.rds")
```
...
tab <- bind_rows(df,df2)
print(xtable(tab, type = "latex",digits=3), file = paste0("../../tables/Posteriors/M9_MainVarPost_P3.tex"), include.rownames=FALSE,sanitize.text.function = function(x) {x})
```
...
p <- ggarrange(p1,p2,p3,labels=c("A","B","C"),font.label = list(size=20),heights = c(0.9,0.35,0.55),nrow=3,vjust=c(1.2,1,1))
ggsave(p,file="../../figs/SuppInfo/M9_PostMainVar_P3.png",height=8) 
p
```
...
pGP
ggsave(pGP, file="../../figs/SuppInfo/M9_GenePoolIntercepts_P3.png",width = 16,height=10)
```
...
```{r loadM10}
mod <- readRDS(file="../../outputs/models/P3/MOD10.rds")
```
...
tab <- bind_rows(df,df2)
print(xtable(tab, type = "latex",digits=3), file = paste0("../../tables/Posteriors/M10_MainVarPost_P3.tex"), include.rownames=FALSE,sanitize.text.function = function(x) {x})
```
...
p <- ggarrange(p1,p2,p3,labels=c("A","B","C"),font.label = list(size=20),heights = c(0.9,0.35,0.55),nrow=3,vjust=c(1.2,1,1))
ggsave(p,file="../../figs/SuppInfo/M10_PostMainVar_P3.png",height=8) 
p
```
...
figs.beta
ggsave(figs.beta, file="../../figs/SuppInfo/M10_ProvClimateVariablesIntercepts_P3.png",width = 16,height=12)
```
...
```{r loadM11}
mod <- readRDS(file="../../outputs/models/P3/MOD11.rds")
```
...
```{r loadM12}
mod <- readRDS(file="../../outputs/models/P3/MOD12.rds") 
```
