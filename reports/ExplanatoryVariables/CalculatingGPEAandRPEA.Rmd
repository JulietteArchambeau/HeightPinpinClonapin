---
title: "Calculating gPEAs and rPEAs"
...
In this script, we create a data frame with the number of positive alleles each gentoype has. @miguelPolygenicAdaptationNegative2020 showed that about 350 SNPs were associated with height in maritime pine. Knowing that, we selected gPEAs and rPEAs in two ways:
