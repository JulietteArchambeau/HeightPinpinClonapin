...
library(usdm)         # CRAN v1.1-18
library(devtools)     # CRAN v2.2.1
...
# saveRDS(varmat.pd, file = "data/EnvMat/VarCovMatSites.rds")
```
...
# saveRDS(varmat.pd, file = "data/EnvMat/VarCovMatProvenancesP1.rds")
```
...
```{r VIFProvenancesP2}
vif(as.data.frame(data[,select.var]))
```
...
# saveRDS(varmat.pd, file = "data/EnvMat/VarCovMatProvenancesP2.rds")
```
